        ...
        <>
            {
                activities && activities.map((activity, indx) => (
                    <Grid key={`activity-${indx}`} item lg={12} className="content-trip border-trip">
                        <Grid container>
                                ...
                                <Grid container>
                                    ...
                                    <Grid item lg={1} className="option">
                                        <Grid container className="flex h-full">
                                            <Grid item lg={12} className="flex justify-end items-start font-medium"><a href="/">Edit</a></Grid>
                                            <Grid item lg={12} className="flex justify-end items-end font-medium"><a href="/">Delete</a></Grid>
                                        </Grid>
                                    </Grid>
                                </Grid>
                            </Grid>
